...
# Introduction
Having gone through the first assessment, we learnt about basic parts of Python. Thereby, the second one is surely be the advanced type. We have five tasks to choose, and I choose to carry out the Drunks way home. 
